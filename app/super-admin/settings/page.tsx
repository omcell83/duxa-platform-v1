...
import { Settings, FileText, Route, BookOpen, Users, Languages, ClipboardList, Activity } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Link href="/super-admin/settings/system-logs">
            <Card className="hover:bg-muted/50 transition-colors cursor-pointer h-full">
              <CardHeader>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-primary/10 rounded-md">
                  ...
                  <div>
                    ...
                    <CardDescription>Olay ve güvenlik kayıtları</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">Giriş denemeleri, hatalar ve sistem logları.</p>
              </CardContent>
            </Card>
          </Link>
